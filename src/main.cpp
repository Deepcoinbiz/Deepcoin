...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Deepcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Deepcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Deepcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Deepcoin: increase each by adding 2 to bitcoin's value.
